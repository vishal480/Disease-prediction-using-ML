...
diabetes_model = pickle.load(open('./trained_data_models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('./trained_data_models/heart_disease_model.sav','rb'))
